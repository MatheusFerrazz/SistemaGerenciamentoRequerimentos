...
{       
        ...
        */
        SELECT_TURNOS_POSSIVEIS_MUDANCA("SELECT DISTINCT turno.* FROM curso"+                
                ...
                "WHERE curso.\"trn_id_FK\"!=? AND curso.\"cam_id_FK\"=? AND curso.cur_nome='INFORMÁTICA' AND curso.\"mod_cur_id_FK\"=?;"),
        
        /*
        Seleciona todos as turmas possíveis para mudança.
        Deve-se passar o ID da turma atual e o ID do curso atual.
        */        
        SELECT_TURMAS_POSSIVEIS_MUDANCA("SELECT * FROM turma WHERE turma.trm_codigo!=? AND turma.\"cur_id_FK\"=?;"),
