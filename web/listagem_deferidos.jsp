            ...
            <div id="consulta" class="row acao">
                <div class="col-md-12" style="padding-left:28px">
                    ...
                    <div id="requerimentos_em_andamento">
                        <h1><font color = "#008000">DEFERIDOS</font></h1><br>
                        <% listarequerimentos = requerimentos.populaAproveitaMentoDeEstudo(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 1, aluno.getMatricula());
                        ...
                        <% listarequerimentos = requerimentos.populaCertificacaoDeConhecimento(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 2, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaReposicaoAtividade(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 3, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaMudancaCurso(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 4, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaMudancaTurma(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 5, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaMudancaTurno(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 6, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaTransferencia(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 7, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaLancamentoRevisaoFaltas(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 8, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaRenovacaoMatricula(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 9, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaReaberturaMatricula(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 10, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaJustificativaDeFaltasEmAnexo(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 11, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaJustificativaDeFaltaDiaEspecifico(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 12, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaJustificativaDeFaltasPeriodo(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 13, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaTrancamentoDeMatricula(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 14, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaTrancamentoDeMatriculaCompusorio(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 15, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaCancelamentoDeMatricula(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 16, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaAtendimentoDomiciliar(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 17, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaOutros(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 18, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        <div id="outros">
                            <div class="container">
                        ...
                        <% listarequerimentos = requerimentos.populaDispensaDeAtividades(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 19, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaAdequacaoHorarios(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 20, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaEstudoIndividualizado(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 21, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaInclusaoDisciplinas(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 22, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
                        ...
                        <% listarequerimentos = requerimentos.populaAproveitaMentoDeEstudo(EnuConsultasRequerimento.SELECT_TODOS_REQUERIMENTOS_DEFERIDOS_POR_TIPO_REQUERIMENTO_E_IDALUNO.toString(), 23, aluno.getMatricula());
                          if(!listarequerimentos.isEmpty()){
                        %>
